...
namespace Selkie.DefCon.One.Common
{
    ...
    {
        [ NotNull ] private readonly IResultMessageBuilder _builder ;

        [ NotNull ] private readonly IInstanceCreator _creator ;

        [ NotNull ] private readonly ILogger _logger ;

        [ NotNull ] private readonly IParameterCreator _parameterCreator ;
